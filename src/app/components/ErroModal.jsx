    ...
    <Modal show={show}>
      <div className="flex flex-col w-96 md:w-[28rem] lg:w-[30.5rem]">
        ...
        <div className="flex flex-col py-6 lg:py-8 2xl:py-10 gap-3 lg:gap-4 2xl:gap-5">
          <div className="flex items-center justify-center size-8 lg:size-10 2xl:size-12 rounded-full bg-[#FEE4E2]">
            <PiWarningCircleLight className="size-4 lg:size-5 text-[#D92D20] " />
          </div>
          {children}
        </div>
      </div>
