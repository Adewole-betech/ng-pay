    ...
    <div className="flex flex-col gap-2 md:gap-4 2xl:gap-6 h-full">
      <div className="bg-white p-4 2xl:p-6 rounded-xl 2xl:rounded-2xl flex flex-col gap-4 2xl:gap-5 h-full">
        <div className="flex items-center justify-between p-3 lg:p-4 2xl:p-6 rounded-lg 2xl:rounded-xl flex-wrap gap-3 lg:gap-4 2xl:gap-5 bg-[center_-500px] bg-no-repeat bg-cover bg-mesh01">
          ...
          <CustomButton className="bg-white flex items-center gap-2 lg:gap-3 text-neutral-900 hover:text-primary-main">
            <ArrowUp />
            Send Money
          </CustomButton>
        </div>
                      ...
                      render={(value, record, _) => {
                        if (column?.dataIndex === "status") {
                          ...
                          if (record?.status === "pending") {
                            return <Button type="link" className="pl-0">Check Status</Button>;
                          } else {
                            return (
